...
|                   | `tlsCertPath`                    | Path to your certificate file                                                                         | ``                                            |
|                   | `serverName `                    | Server name                                                                                           | ``                                            |
| `minio`           | `storageType`                    | Storage type for Milvus (e.g., `local`, `minio`, `s3`, `aws`, `gcp`, `ali(aliyun)`, `azure`, `tc(tencent)`). # You can use "gcpnative" for the Google Cloud Platform provider. Uses service account credentials for authentication.                                                 | `minio`                                       |
